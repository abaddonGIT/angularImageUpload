    ...
    <li>
        ...
        <ul>
            <li>
                ...
                Директива также принимает указание, какой загрузчик использовать если браузер не поддерживает HTML5. Если директива <b>data-uploade-source</b> вызвана без параметра,
                то при отсутствии поддержки html5 будет использован загрузчик через iFrame. Если передан параметр "flash", то будет использована загрузка через flash при помощи библиотеки
                <b>SWFupload</b>
                В связке с полем загрузки файлов также можно использовать поле для Drag and Drop:
                <pre>
